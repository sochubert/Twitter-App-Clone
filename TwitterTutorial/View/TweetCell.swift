...
//  TwitterTutorial
//
//  Created by Minjae Lee on 2022/12/27.
//
...
class TweetCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        infoLabel.text = "Minjae Lee @sochubert"
        
        let actionStack = UIStackView(arrangedSubviews: [commentButton, retweetButton, likedButton, shareButton])
